...
public class RigidBars4FactoryTest {
    RigidBars4Factory factory = new RigidBars4Factory();
    ...
    @Test
    public void numberOfRigidBars4ShouldBeTwiceAsLargeAsNumberOfModulesInWardrobe() {
        List<TableItem> tableItems = factory.create(wardrobe);

        int numberOfRigidBars4 = 0;
        for (TableItem tableItem : tableItems) {
            numberOfRigidBars4 += tableItem.getQuantity();
        }
        assertEquals(numberOfDoors * numberOfModules * 2, numberOfRigidBars4);
    ...
    @Test
    public void allRigidBars4InTheSameDimentionShouldBeSummarizedAndVisibleAsOneListItem() {
        expect(calculator.calculate(anyObject(), anyObject()))
                .andReturn(44)
                .andReturn(57)
                .andReturn(44)
    ...
    @Test
    public void whenManyRigidBars4InDiffrentAndSameSizes_ThenAllOfRigidBars4ShouldBePresentInList() {
        expect(calculator.calculate(anyObject(), anyObject()))
                .andReturn(57)
                .andReturn(97)
                .andReturn(67)
